...
<section class="home-section">
    ...
    <div class="cadastro">
        ...
        <form class="form" action="" method="POST">
            <input type="hidden" name="codAdm" value="<?= $_GET['codAdm'] ?>">
            ...
            <div class="alterar">
                <div class="button">
                    <button class="botao botao-alterar" type="submit" name="salvar"><i class="fa-solid fa-check"></i> Cadastrar</button>
                </div>
                <div class="button">
                    <a href="listarAdm.php" class="botao botao-voltar"><i class="fa-solid fa-rotate-left"></i> Voltar</a>
                </div>
            </div>
