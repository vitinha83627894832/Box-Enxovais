...
if (isset($_POST['salvar'])) {
  ...
  $nomeMarcaProd = $_POST['nomeMarcaProd'];


  // Validação
  $sql = "SELECT * FROM marca_produto WHERE nomeMarcaProd = '{$nomeMarcaProd}'";
  ...
  if ($linhas <= 0) { //se não tem a marca ainda, cadastra a nova marca  
    ...
    $sql = "INSERT INTO marca_produto (nomeMarcaProd) VALUES ('$nomeMarcaProd')";
    ...
    $mensagemErro = "Marca já cadastrada!";
  }
}
?>
...
<section class="home-section">
  ...
  <div class="cadastro">
    ...
    <div class="title">Cadastro de Marca Produto</div>
    <form class="form" action="" method="POST">

      <div class="user-details">
        <div class="input-box">
          <label class="details" for="nomeMarcaProd">Nome do Produto</label>
          <input class="input" type="text" id="nomeMarcaProd" name="nomeMarcaProd" placeholder="Ex: Bella Enxovais" required />
        </div>
      </div>
      ...
      if (isset($mensagem)) { ?>
        <div class="button">
          <a class="input btn-voltar" href="listarMarcaProduto.php">Voltar</a>
        </div>
      <?php }
      ?>
    </form>
