...
$sql = "SELECT p.codProd, p.nomeProd, p.status, mp.nomeMarcaProd
FROM produto p
JOIN marca_produto mp ON p.marca_produto_cod = mp.codMarcaProd
WHERE 1 = 1" . $V_WHERE;
...
<section class="home-section">
    ...
    <div class="card-listar">
                ...
                <div class="input-group">
                    <div class="input-box">
                        ...
                        <div class="search-box">
                            <input type="text" class="search-text" placeholder="Nome da Marca" id="nomeMarca" name="nomeMarca" />
        ...
        <div class="card-body">
            <h2 class="title-marca">Relatório Produto/Marca</h2>
                ...
                <tbody>
                    <?php while ($linha = mysqli_fetch_array($resultado)) { ?>
                        <tr>
                            ...
                            <td data-lable="Nome Marca"><?= $linha['nomeMarcaProd'] ?></td>
