...
$sql = "SELECT codProd, nomeProd, valor, arquivo, arquivo2 
        FROM produto
        inner join tipo_produto on tipo_produto.codTipoProd = produto.tipo_produto_cod 
        inner join categoria on categoria.id = tipo_produto.categoria_id
        where categoria.id = " . $_GET['id'];
      ...
      <?php while ($row = mysqli_fetch_array($resultado)) { ?>
        ...
        <div class="card">
          ...
          <div class="card-body d-flex flex-column">
            ...
            <a href="telaProduto.php" class="btn btn-primary btn-lg btn-block mt-auto active" role="button" aria-pressed="true">Adicionar ao Carrinho</a>
          </div>
